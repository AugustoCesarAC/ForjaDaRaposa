package com.fdr.forjadaraposa.security;
...
public class BasicSecurityConfig extends WebSecurityConfigurerAdapter 
{
	...
	protected void configure(HttpSecurity http) throws Exception {
		...
		http.authorizeRequests()
			...
			.antMatchers(HttpMethod.GET, "/produtos/*").permitAll()
			.antMatchers(HttpMethod.GET, "/produtos/maiorc/*").permitAll()
			.antMatchers(HttpMethod.GET, "/produtos/menorc/*").permitAll()
			.antMatchers(HttpMethod.GET, "/produtos/curtidas/*").permitAll()
			.antMatchers(HttpMethod.GET, "/produtos/maiord/*").permitAll()
			.antMatchers(HttpMethod.GET, "/produtos/menord/*").permitAll()
			.antMatchers(HttpMethod.GET, "/produtos/recente/*").permitAll()
